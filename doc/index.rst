.. farc-hd-sklearn documentation master file, created by
...
**Useful links**:
`Source Repository <https://github.com/scikit-learn-contrib/farc-hd-sklearn>`__ |
`Issues & Ideas <https://github.com/scikit-learn-contrib/farc-hd-sklearnk/issues>`__ |

This is the documentation for the `farc-hd-sklearn` to help at extending
